...
public interface EVP_PKEY_meth_set_decrypt$decrypt {
    ...
    static CLinker.UpcallStub allocate(EVP_PKEY_meth_set_decrypt$decrypt fi) {
        return RuntimeHelper.upcallStub(EVP_PKEY_meth_set_decrypt$decrypt.class, fi, constants$363.EVP_PKEY_meth_set_decrypt$decrypt$FUNC, "(Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;J)I");
    }
    static CLinker.UpcallStub allocate(EVP_PKEY_meth_set_decrypt$decrypt fi, ResourceScope scope) {
    ...
    static EVP_PKEY_meth_set_decrypt$decrypt ofAddress(MemoryAddress addr) {
        return (jdk.incubator.foreign.MemoryAddress x0, jdk.incubator.foreign.MemoryAddress x1, jdk.incubator.foreign.MemoryAddress x2, jdk.incubator.foreign.MemoryAddress x3, long x4) -> {
            try {
                return (int)constants$363.EVP_PKEY_meth_set_decrypt$decrypt$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4);
            } catch (Throwable ex$) {
