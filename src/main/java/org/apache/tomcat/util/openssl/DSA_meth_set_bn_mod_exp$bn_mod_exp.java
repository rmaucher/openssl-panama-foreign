...
public interface DSA_meth_set_bn_mod_exp$bn_mod_exp {
    ...
    static NativeSymbol allocate(DSA_meth_set_bn_mod_exp$bn_mod_exp fi, ResourceScope scope) {
    ...
    static DSA_meth_set_bn_mod_exp$bn_mod_exp ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("DSA_meth_set_bn_mod_exp$bn_mod_exp::" + Long.toHexString(addr.toRawLongValue()), addr, scope);return (jdk.incubator.foreign.MemoryAddress x0, jdk.incubator.foreign.MemoryAddress x1, jdk.incubator.foreign.MemoryAddress x2, jdk.incubator.foreign.MemoryAddress x3, jdk.incubator.foreign.MemoryAddress x4, jdk.incubator.foreign.MemoryAddress x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                return (int)constants$474.DSA_meth_set_bn_mod_exp$bn_mod_exp$MH.invokeExact(symbol, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
