...
public interface SSL_CTX_set_msg_callback$cb {
    ...
    static CLinker.UpcallStub allocate(SSL_CTX_set_msg_callback$cb fi) {
        return RuntimeHelper.upcallStub(SSL_CTX_set_msg_callback$cb.class, fi, constants$764.SSL_CTX_set_msg_callback$cb$FUNC, "(IIILjdk/incubator/foreign/MemoryAddress;JLjdk/incubator/foreign/MemoryAddress;Ljdk/incubator/foreign/MemoryAddress;)V");
    }
    static CLinker.UpcallStub allocate(SSL_CTX_set_msg_callback$cb fi, ResourceScope scope) {
    ...
    static SSL_CTX_set_msg_callback$cb ofAddress(MemoryAddress addr) {
        return (int x0, int x1, int x2, jdk.incubator.foreign.MemoryAddress x3, long x4, jdk.incubator.foreign.MemoryAddress x5, jdk.incubator.foreign.MemoryAddress x6) -> {
            try {
                constants$764.SSL_CTX_set_msg_callback$cb$MH.invokeExact((Addressable)addr, x0, x1, x2, x3, x4, x5, x6);
            } catch (Throwable ex$) {
