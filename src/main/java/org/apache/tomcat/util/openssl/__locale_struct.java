...
public class __locale_struct {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, ADDRESS).withName("__locales"),
        ADDRESS.withName("__ctype_b"),
        ADDRESS.withName("__ctype_tolower"),
        ADDRESS.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, ADDRESS).withName("__names")
    ...
    public static MemoryAddress __ctype_b$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)__locale_struct.__ctype_b$VH.get(seg);
    }
    ...
    public static MemoryAddress __ctype_b$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)__locale_struct.__ctype_b$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress __ctype_tolower$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)__locale_struct.__ctype_tolower$VH.get(seg);
    }
    ...
    public static MemoryAddress __ctype_tolower$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)__locale_struct.__ctype_tolower$VH.get(seg.asSlice(index*sizeof()));
    }
    ...
    public static MemoryAddress __ctype_toupper$get(MemorySegment seg) {
        return (jdk.incubator.foreign.MemoryAddress)__locale_struct.__ctype_toupper$VH.get(seg);
    }
    ...
    public static MemoryAddress __ctype_toupper$get(MemorySegment seg, long index) {
        return (jdk.incubator.foreign.MemoryAddress)__locale_struct.__ctype_toupper$VH.get(seg.asSlice(index*sizeof()));
    }
