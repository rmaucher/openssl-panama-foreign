...
public class _IO_FILE {
    ...
    static final MemoryLayout $struct$LAYOUT = MemoryLayout.structLayout(
        ...
        ADDRESS.withName("_IO_read_ptr"),
        ADDRESS.withName("_IO_read_end"),
        ADDRESS.withName("_IO_read_base"),
        ADDRESS.withName("_IO_write_base"),
        ADDRESS.withName("_IO_write_ptr"),
        ADDRESS.withName("_IO_write_end"),
        ADDRESS.withName("_IO_buf_base"),
        ADDRESS.withName("_IO_buf_end"),
        ADDRESS.withName("_IO_save_base"),
        ADDRESS.withName("_IO_backup_base"),
        ADDRESS.withName("_IO_save_end"),
        ADDRESS.withName("_markers"),
        ADDRESS.withName("_chain"),
        ...
        MemoryLayout.paddingLayout(32),
        ADDRESS.withName("_lock"),
        JAVA_LONG.withName("_offset"),
        ADDRESS.withName("_codecvt"),
        ADDRESS.withName("_wide_data"),
        ADDRESS.withName("_freeres_list"),
        ADDRESS.withName("_freeres_buf"),
