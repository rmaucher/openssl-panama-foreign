...
public interface EC_KEY_METHOD_get_sign$psign {
    ...
    static NativeSymbol allocate(EC_KEY_METHOD_get_sign$psign fi, ResourceScope scope) {
    ...
    static EC_KEY_METHOD_get_sign$psign ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("EC_KEY_METHOD_get_sign$psign::" + Long.toHexString(addr.toRawLongValue()), addr, scope);return (int x0, jdk.incubator.foreign.MemoryAddress x1, int x2, jdk.incubator.foreign.MemoryAddress x3, jdk.incubator.foreign.MemoryAddress x4, jdk.incubator.foreign.MemoryAddress x5, jdk.incubator.foreign.MemoryAddress x6, jdk.incubator.foreign.MemoryAddress x7) -> {
            try {
                return (int)constants$418.EC_KEY_METHOD_get_sign$psign$MH.invokeExact(symbol, x0, x1, x2, x3, x4, x5, x6, x7);
            } catch (Throwable ex$) {
