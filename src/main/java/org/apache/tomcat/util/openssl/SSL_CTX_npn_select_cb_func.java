...
public interface SSL_CTX_npn_select_cb_func {
    ...
    static NativeSymbol allocate(SSL_CTX_npn_select_cb_func fi, ResourceScope scope) {
    ...
    static SSL_CTX_npn_select_cb_func ofAddress(MemoryAddress addr, ResourceScope scope) {
        NativeSymbol symbol = NativeSymbol.ofAddress("SSL_CTX_npn_select_cb_func::" + Long.toHexString(addr.toRawLongValue()), addr, scope);return (jdk.incubator.foreign.MemoryAddress x0, jdk.incubator.foreign.MemoryAddress x1, jdk.incubator.foreign.MemoryAddress x2, jdk.incubator.foreign.MemoryAddress x3, int x4, jdk.incubator.foreign.MemoryAddress x5) -> {
            try {
                return (int)constants$772.SSL_CTX_npn_select_cb_func$MH.invokeExact(symbol, x0, x1, x2, x3, x4, x5);
            } catch (Throwable ex$) {
